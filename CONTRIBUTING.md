Contributing to NEBULAPROJECT Core
============================

The NEBULAPROJECT Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/nebulaproject-project/nebulaproject/blob/master/doc/translation_process.md)
...
The following applies to code changes to the NEBULAPROJECT Core project, and is not to be
confused with overall NEBULAPROJECT Network Protocol consensus changes.

Whether a pull request is merged into NEBULAPROJECT Core rests with the project merge
...
Patches that change NEBULAPROJECT consensus rules are considerably more involved than
...
Where a patchset proposes to change the NEBULAPROJECT consensus, it must have been
...
The project leader is the release manager for each NEBULAPROJECT Core release.
