...
# Copyright (c) 2018-2023 The NEBULAPROJECT Core developers
...
EXCLUDE = [
    # auto generated:
    'src/qt/nebulaprojectstrings.cpp',
...
EXPECTED_HOLDER_NAMES = [
    ...
    r"The NEBULAPROJECT Core developers",
...
YEAR = "20[0-9][0-9]"
YEAR_RANGE = '(%s)(-%s)?' % (YEAR, YEAR)
HOLDER = 'The NEBULAPROJECT Core developers'
...
Arguments:
    <base_directory> - The base directory of a nebulaproject source code repository.
"""
...
CPP_HEADER = '''
// Copyright (c) %s The NEBULAPROJECT Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.
'''
...
def exec_insert_header(filename, style):
    ...
    if file_already_has_core_copyright(file_lines):
        sys.exit('*** %s already has a copyright by The NEBULAPROJECT Core developers'
                 % (filename))
