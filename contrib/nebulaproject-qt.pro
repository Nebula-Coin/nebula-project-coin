...
HEADERS += src/activemasternode.h \
           ...
           src/walletdb.h \
           src/compat/sanity.h \
           src/config/nebulaproject-config.h \
           src/crypto/common.h \
...
SOURCES += src/activemasternode.cpp \
           ...
           src/obfuscation.cpp \
           src/nebulaproject-cli.cpp \
           src/nebulaproject-tx.cpp \
           src/nebulaproject.cpp \
           src/db.cpp \
           ...
           src/test/test_nebulaproject.cpp \
...
RESOURCES += src/qt/nebulaproject.qrc src/qt/nebulaproject_locale.qrc

TRANSLATIONS += src/qt/locale/nebulaproject_bg.ts \
                src/qt/locale/nebulaproject_de.ts \
                src/qt/locale/nebulaproject_en.ts \
                src/qt/locale/nebulaproject_es.ts \
                src/qt/locale/nebulaproject_fi.ts \
                src/qt/locale/nebulaproject_fr.ts \
                src/qt/locale/nebulaproject_it.ts \
                src/qt/locale/nebulaproject_ja.ts \
                src/qt/locale/nebulaproject_pl.ts \
                src/qt/locale/nebulaproject_pt.ts \
                src/qt/locale/nebulaproject_ru.ts \
                src/qt/locale/nebulaproject_sk.ts \
                src/qt/locale/nebulaproject_sv.ts \
                src/qt/locale/nebulaproject_vi.ts \
                src/qt/locale/nebulaproject_zh_CN.ts \
                src/qt/locale/nebulaproject_zh_TW.ts
