UNIX BUILD NOTES
====================
Some notes on how to build NEBULAPROJECT Core in Unix.

Note
---------------------
Always use absolute paths to configure and compile NEBULAPROJECT Core and the dependencies,
...
This will build nebulaproject-qt as well, if the dependencies are met.
...
memory available when compiling NEBULAPROJECT Core. On systems with less, gcc can be
 ...
 **For Ubuntu only:** db4.8 packages are available [here](https://launchpad.net/~nebulaproject/+archive/nebulaproject).
...
To build NEBULAPROJECT Core without wallet, see [*Disable-wallet mode*](/doc/build-unix.md#disable-wallet-mode)
...
If you want to build nebulaproject-qt, make sure that the required packages for Qt development
...
Once these are installed, they will be found by configure and a nebulaproject-qt executable will be
built by default.
...
Notes
-----
The release is built with GCC and then "strip nebulaprojectd" to strip the debug
...
Security
--------
To help make your NEBULAPROJECT Core installation more secure by making certain attacks impossible to
...
* _Non-executable Stack_: If the stack is executable then trivial stack-based buffer overflow exploits are possible if
    vulnerable buffers are found. By default, NEBULAPROJECT Core should be built with a non-executable stack
