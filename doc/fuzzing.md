Fuzz-testing NEBULAPROJECT Core
==========================
...
To build NEBULAPROJECT Core using AFL instrumentation (this assumes that the
...
with certain assembly code from NEBULAPROJECT Core's code. See [developer notes on sanitizers](https://github.com/Nebula-Project/nebula-project/blob/master/doc/developer-notes.md#sanitizers)
