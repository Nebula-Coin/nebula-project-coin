...
The script [extract-osx-sdk.sh](https://github.com/nebulaproject-project/nebulaproject/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
nebulaproject/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/nebulaproject-project/nebulaproject/blob/master/doc/README_osx.md) for troubleshooting tips.