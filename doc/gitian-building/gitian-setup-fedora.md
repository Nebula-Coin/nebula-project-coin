...
The build script we'll be using is contained in the NEBULAPROJECT github repository ([contrib/gitian-build.py](https://github.com/nebulaproject-project/nebulaproject/blob/master/contrib/gitian-build.py)). Since this is a completely fresh environment, we haven't yet cloned the NEBULAPROJECT repository and will need to fetch this script with the following commands:

```bash
curl -L -O https://raw.githubusercontent.com/Nebula-Project/nebula-project/master/contrib/gitian-build.py
...
- Clone the gitian-builder, gitian.sigs, nebulaproject-detached-sigs, and nebulaproject GitHub repos.
