NEBULAPROJECT Core version v5.1.0 is now available from:  <https://github.com/nebulaproject-project/nebulaproject/releases>
...
- #2170 Better nebulaproject.conf Masternode data error notification (furszy)
