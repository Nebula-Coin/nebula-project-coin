...
#error Client version information missing: version is not defined by nebulaproject-config.h or in any other way
#endif
...
/**
 * nebulaprojectd-res.rc includes this file, but it cannot cope with real c++ code.
