...
public:
    ...
    /**
     * Amount of nebulaproject coming in to a transaction
...
// NEBULAPROJECT: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
