...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " nebulaproject-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  nebulaproject-tx [options] <hex-tx> [commands]  Update hex-encoded nebulaproject transaction\n" +
                               "or:     nebulaproject-tx [options] -create [commands]   Create hex-encoded nebulaproject transaction\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded nebulaproject transaction
