...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("Nebulaproject Core nebulaproject-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  nebulaproject-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded nebulaproject transaction") + "\n" +
                               "  nebulaproject-tx [options] -create [commands]   " + _("Create hex-encoded nebulaproject transaction") + "\n" +
                               "\n";
