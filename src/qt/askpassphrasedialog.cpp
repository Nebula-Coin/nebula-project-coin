...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            NEBULAPROJECTGUI* window = static_cast<NEBULAPROJECTGUI*>(parentWidget());
...
{
    NEBULAPROJECTGUI* gui = static_cast<NEBULAPROJECTGUI*>(parentWidget());
...
{
    hide();
    static_cast<NEBULAPROJECTGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
            tr("NEBULAPROJECT will close now to finish the encryption process. "
