...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(NBLA);
    unitlist.append(mNBLA);
    unitlist.append(uNBLA);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case NBLA:
        return QString("nebulaproject");
    case mNBLA:
        return QString("mnebulaproject");
    case uNBLA:
        return QString::fromUtf8("unebulaproject");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZnbla)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNBLA)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZNBLA);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZNBLA)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZNBLA));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
