...
/** Utility functions used by the NEBULAPROJECT Qt UI.
 */
namespace GUIUtil
{
...
// Render NEBULAPROJECT addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZnbla = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZnbla = false);
...
// Parse "nebulaproject:" URI into recipient object, return true on successful parsing
