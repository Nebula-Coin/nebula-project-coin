...
#include "qt/nebulaproject/forms/ui_addresseswidget.h"
#include "qt/nebulaproject/addresslabelrow.h"
#include "qt/nebulaproject/addnewaddressdialog.h"
...
AddressesWidget::AddressesWidget(NEBULAPROJECTGUI* parent) :
    PWidget(parent),
