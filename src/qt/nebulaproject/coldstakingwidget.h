...
#include "qt/nebulaproject/txviewholder.h"
#include "qt/nebulaproject/tooltipmenu.h"
#include "qt/nebulaproject/sendmultirow.h"
#include "qt/nebulaproject/coldstakingmodel.h"
#include "qt/nebulaproject/contactsdropdown.h"
#include "qt/nebulaproject/addressholder.h"
...
public:
    explicit ColdStakingWidget(NEBULAPROJECTGUI* parent);
    ~ColdStakingWidget();
