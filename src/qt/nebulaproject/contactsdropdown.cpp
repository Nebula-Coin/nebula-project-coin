...
#include <QPainter>
#include <QSizePolicy>
#include "qt/nebulaproject/addresslabelrow.h"
#include "qt/nebulaproject/contactdropdownrow.h"
...
ContactsDropdown::ContactsDropdown(int minWidth, int minHeight, NEBULAPROJECTGUI* _window, QWidget* _parent) : PWidget(_window, _parent)
{
