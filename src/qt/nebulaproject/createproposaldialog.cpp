...
#include "qt/nebulaproject/createproposaldialog.h"
#include "qt/nebulaproject/forms/ui_createproposaldialog.h"

#include "qt/nebulaproject/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(NEBULAPROJECTGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.nebulaproject.io/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 NBLA");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<NEBULAPROJECTGUI*>(parent()),
                this
        );
