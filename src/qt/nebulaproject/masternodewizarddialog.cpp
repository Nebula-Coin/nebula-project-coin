...
#include "qt/nebulaproject/forms/ui_masternodewizarddialog.h"
    ...
    clientModel(_clientModel)
{
    ...
    ui->labelMessage1a->setText(formatHtmlContent(
                formatParagraph(tr("To create a NEBULAPROJECT Masternode you must dedicate %1 (the unit of NEBULAPROJECT) "
    ...
    if (walletModel->isRegTestNetwork()) {
        ui->lineEditPort->setText("2018");
    } else if (walletModel->isTestNetwork()) {
        ui->lineEditPort->setText("1918");
    } else {
        ui->lineEditPort->setText("1818");
    }
