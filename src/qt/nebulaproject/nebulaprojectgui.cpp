...
const QString NEBULAPROJECTGUI::DEFAULT_WALLET = "~Default";

NEBULAPROJECTGUI::NEBULAPROJECTGUI(const NetworkStyle* networkStyle, QWidget* parent) :
        QMainWindow(parent),
        clientModel(0){
...
void NEBULAPROJECTGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    connect(toggleHideAction, &QAction::triggered, this, &NEBULAPROJECTGUI::toggleHidden);
 ...
 */
void NEBULAPROJECTGUI::connectActions()
{
    ...
    connect(topBar, &TopBar::showHide, this, &NEBULAPROJECTGUI::showHide);
    connect(topBar, &TopBar::themeChanged, this, &NEBULAPROJECTGUI::changeTheme);
    connect(topBar, &TopBar::onShowHideColdStakingChanged, navMenu, &NavMenuWidget::onShowHideColdStakingChanged);
    connect(settingsWidget, &SettingsWidget::showHide, this, &NEBULAPROJECTGUI::showHide);
    connect(sendWidget, &SendWidget::showHide, this, &NEBULAPROJECTGUI::showHide);
    connect(receiveWidget, &ReceiveWidget::showHide, this, &NEBULAPROJECTGUI::showHide);
    connect(addressesWidget, &AddressesWidget::showHide, this, &NEBULAPROJECTGUI::showHide);
    connect(masterNodesWidget, &MasterNodesWidget::showHide, this, &NEBULAPROJECTGUI::showHide);
...
void NEBULAPROJECTGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
#ifndef Q_OS_MAC
...
NEBULAPROJECTGUI::~NEBULAPROJECTGUI()
{
...
void NEBULAPROJECTGUI::handleRestart(QStringList args)
{
...
void NEBULAPROJECTGUI::setClientModel(ClientModel* _clientModel)
{
...
void NEBULAPROJECTGUI::createTrayIconMenu()
{
#ifndef Q_OS_MAC
    ...
    connect(trayIcon, &QSystemTrayIcon::activated, this, &NEBULAPROJECTGUI::trayIconActivated);
#else
    // Note: On macOS, the Dock icon is used to provide the tray's functionality.
    MacDockIconHandler* dockIconHandler = MacDockIconHandler::instance();
    connect(dockIconHandler, &MacDockIconHandler::dockIconClicked, this, &NEBULAPROJECTGUI::macosDockIconActivated);
...
#ifndef Q_OS_MAC
void NEBULAPROJECTGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
#else
void NEBULAPROJECTGUI::macosDockIconActivated()
 {
     show();
     activateWindow();
 }
...
void NEBULAPROJECTGUI::changeEvent(QEvent* e)
{
...
void NEBULAPROJECTGUI::closeEvent(QCloseEvent* event)
{
#ifndef Q_OS_MAC // Ignored on Mac
...
void NEBULAPROJECTGUI::messageInfo(const QString& text)
{
...
bool NEBULAPROJECTGUI::openStandardDialog(QString title, QString body, QString okBtn, QString cancelBtn)
{
...
void NEBULAPROJECTGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if (!clientModel)
        return;
...
void NEBULAPROJECTGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void NEBULAPROJECTGUI::detectShutdown()
{
    if (ShutdownRequested()) {
        if (rpcConsole)
            rpcConsole->hide();
...
void NEBULAPROJECTGUI::goToDashboard()
{
...
void NEBULAPROJECTGUI::goToSend()
{
    showTop(sendWidget);
}

void NEBULAPROJECTGUI::goToAddresses()
{
    showTop(addressesWidget);
}

void NEBULAPROJECTGUI::goToMasterNodes()
{
...
void NEBULAPROJECTGUI::goToSettingsInfo()
{
    navMenu->selectSettings();
...
void NEBULAPROJECTGUI::goToReceive()
{
    showTop(receiveWidget);
}

void NEBULAPROJECTGUI::openNetworkMonitor()
{
    settingsWidget->openNetworkMonitor();
}

void NEBULAPROJECTGUI::showTop(QWidget* view)
{
...
void NEBULAPROJECTGUI::changeTheme(bool isLightTheme)
{
...
void NEBULAPROJECTGUI::resizeEvent(QResizeEvent* event)
{
    // Parent..
...
bool NEBULAPROJECTGUI::execDialog(QDialog *dialog, int xDiv, int yDiv)
{
    return openDialogWithOpaqueBackgroundY(dialog, this);
}

void NEBULAPROJECTGUI::showHide(bool show)
{
...
int NEBULAPROJECTGUI::getNavWidth()
{
...
bool NEBULAPROJECTGUI::addWallet(const QString& name, WalletModel* walletModel)
{
    ...
    // Connect actions..
    connect(walletModel, &WalletModel::message, this, &NEBULAPROJECTGUI::message);
    connect(masterNodesWidget, &MasterNodesWidget::message, this, &NEBULAPROJECTGUI::message);
    connect(coldStakingWidget, &ColdStakingWidget::message, this, &NEBULAPROJECTGUI::message);
    connect(topBar, &TopBar::message, this, &NEBULAPROJECTGUI::message);
    ...
    connect(dashboard, &DashboardWidget::incomingTransaction, this, &NEBULAPROJECTGUI::incomingTransaction);

    return true;
}

bool NEBULAPROJECTGUI::setCurrentWallet(const QString& name)
{
    // Single wallet supported.
    return true;
}

void NEBULAPROJECTGUI::removeAllWallets()
{
    // Single wallet supported.
}

void NEBULAPROJECTGUI::incomingTransaction(const QString& date, int unit, const CAmount& amount, const QString& type, const QString& address)
{
...
static bool ThreadSafeMessageBox(NEBULAPROJECTGUI* gui, const std::string& message, const std::string& caption, unsigned int style)
{
...
void NEBULAPROJECTGUI::subscribeToCoreSignals()
{
...
void NEBULAPROJECTGUI::unsubscribeFromCoreSignals()
{
