...
#ifndef NEBULAPROJECT_CORE_NEW_GUI_NEBULAPROJECTGUI_H
#define NEBULAPROJECT_CORE_NEW_GUI_NEBULAPROJECTGUI_H
...
/**
  NEBULAPROJECT GUI main class. This class represents the main window of the NEBULAPROJECT UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class NEBULAPROJECTGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit NEBULAPROJECTGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~NEBULAPROJECTGUI();
...
#endif //NEBULAPROJECT_CORE_NEW_GUI_NEBULAPROJECTGUI_H
