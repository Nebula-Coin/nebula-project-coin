...
#include "qt/nebulaproject/sendcustomfeedialog.h"
#include "qt/nebulaproject/forms/ui_sendcustomfeedialog.h"
...
SendCustomFeeDialog::SendCustomFeeDialog(NEBULAPROJECTGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &NEBULAPROJECTGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
