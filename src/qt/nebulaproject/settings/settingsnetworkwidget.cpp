...
#include "qt/nebulaproject/settings/settingsnetworkwidget.h"
#include "qt/nebulaproject/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/nebulaproject/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(NEBULAPROJECTGUI* _window, QWidget *parent) :
