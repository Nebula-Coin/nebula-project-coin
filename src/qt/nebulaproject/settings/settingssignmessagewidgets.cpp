...
#include "qt/nebulaproject/settings/forms/ui_settingssignmessagewidgets.h"
...
SettingsSignMessageWidgets::SettingsSignMessageWidgets(NEBULAPROJECTGUI* _window, QWidget *parent) :
