...
#include "qt/nebulaproject/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/nebulaproject/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(NEBULAPROJECTGUI* _window, QWidget *parent) :
