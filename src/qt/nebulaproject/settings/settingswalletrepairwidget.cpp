// Copyright (c) 2019-2020 The NEBULAPROJECT Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/nebulaproject/settings/settingswalletrepairwidget.h"
#include "qt/nebulaproject/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/nebulaproject/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(NEBULAPROJECTGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to NEBULAPROJECTGUI::handleRestart()
