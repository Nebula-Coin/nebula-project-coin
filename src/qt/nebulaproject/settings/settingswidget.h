...
#include "qt/nebulaproject/settings/settingsbackupwallet.h"
#include "qt/nebulaproject/settings/settingsexportcsv.h"
#include "qt/nebulaproject/settings/settingsbittoolwidget.h"
#include "qt/nebulaproject/settings/settingssignmessagewidgets.h"
#include "qt/nebulaproject/settings/settingswalletrepairwidget.h"
...
public:
    explicit SettingsWidget(NEBULAPROJECTGUI* parent);
    ~SettingsWidget();
