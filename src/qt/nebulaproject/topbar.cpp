...
#include "qt/nebulaproject/topbar.h"
#include "qt/nebulaproject/forms/ui_topbar.h"
#include "qt/nebulaproject/lockunlock.h"
#include "qt/nebulaproject/qtutils.h"
#include "qt/nebulaproject/receivedialog.h"
#include "qt/nebulaproject/loadingdialog.h"
#include "askpassphrasedialog.h"

#include "bitcoinunits.h"
#include "qt/nebulaproject/balancebubble.h"
...
TopBar::TopBar(NEBULAPROJECTGUI* _mainWindow, QWidget *parent) :
    ...
    ui(new Ui::TopBar)
{
    ...
    setCssProperty({ui->labelAmountTopNbla, ui->labelAmountTopShieldedNbla}, "amount-small-topbar");
    setCssProperty({ui->labelAmountNbla}, "amount-topbar");
    setCssProperty({ui->labelPendingNbla, ui->labelImmatureNbla}, "amount-small-topbar");
...
void TopBar::loadWalletModel()
{
    ...
    // update the display unit, to not use the default ("NEBULAPROJECT")
    updateDisplayUnit();
...
void TopBar::updateBalances(const interfaces::WalletBalances& newBalance)
{
    ...
    // NBLA Total
    QString totalNbla = GUIUtil::formatBalance(newBalance.balance, nDisplayUnit);
    ...
    // NBLA
    // Top
    ui->labelAmountTopNbla->setText(totalTransparent);
    ui->labelAmountTopShieldedNbla->setText(totalShielded);
    // Expanded
    ui->labelAmountNbla->setText(totalNbla);
    ui->labelPendingNbla->setText(GUIUtil::formatBalance(newBalance.unconfirmed_balance + newBalance.unconfirmed_shielded_balance, nDisplayUnit));
    ui->labelImmatureNbla->setText(GUIUtil::formatBalance(newBalance.immature_balance, nDisplayUnit));
}
