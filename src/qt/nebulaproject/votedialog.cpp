...
#include "qt/nebulaproject/forms/ui_votedialog.h"

#include "qt/nebulaproject/mnmodel.h"
#include "qt/nebulaproject/mnselectiondialog.h"
...
{
    NEBULAPROJECTGUI* window = dynamic_cast<NEBULAPROJECTGUI*>(parent());
