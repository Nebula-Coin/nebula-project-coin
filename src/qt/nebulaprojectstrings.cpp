...
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to listen on any port. Use %s if you want this."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Warning: Unsupported argument %s ignored, use %s."),
QT_TRANSLATE_NOOP("nebulaproject-core", "You can not start a masternode in litemode"),
