...
QT_TRANSLATE_NOOP("nebulaproject-core", "%s Invalid %s address or hostname: '%s'"),
QT_TRANSLATE_NOOP("nebulaproject-core", "%s corrupt, salvage failed"),
QT_TRANSLATE_NOOP("nebulaproject-core", "%s is not allowed in combination with enabled wallet functionality"),
QT_TRANSLATE_NOOP("nebulaproject-core", "%s is only allowed with a single wallet file"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot be a masternode and only connect to specific nodes"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot downgrade wallet."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot resolve -%s address: '%s'"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot set %s or %s together with %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot upgrade a locked wallet."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Cannot write to data directory '%s'; check permissions."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Copyright (C) 2015-%i The %s Developers"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Corrupted block database detected"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Could not find asmap file %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Could not open debug log file %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Could not parse asmap file %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Could not parse masternode.conf"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Deterministic masternodes are not enforced yet"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Elliptic curve cryptography sanity check failure. Aborting."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error initializing block database"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error initializing wallet database environment %s!"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error loading %s: Wallet corrupted"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error loading %s: Wallet requires newer version of %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error loading %s\n"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error loading block database"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error loading wallet %s. Duplicate %s filename specified."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Error reading masternode configuration file: %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error upgrading chainstate database"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: %s must be at least %d MB"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: %s must be true if %s is set."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: A fatal internal error occurred, see debug.log for details"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: Disk space is low for %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: Disk space is low!"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: Initializing networking failed"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: Unsupported argument %s found, use %s."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Error: Unsupported argument %s found. Checklevel must be level 4."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to accept tx in the memory pool (reason: %s)\n"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to clear masternode metadata cache at: %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to delete backup, error: %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to listen on any port. Use -listen=0 if you want this."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to load masternode metadata cache from: %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to parse host:port string"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Failed to rescan the wallet during initialization"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Invalid activation height (%s)"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Invalid amount for %s: '%s' (must be at least %s)"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Invalid mnoperatorprivatekey. Please see the documentation."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Invalid netmask specified in %s: '%s'"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Invalid network upgrade (%s)"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Legacy Masternode is obsolete."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Loading network requests cache..."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Masternode must be able to handle at least %d connections, set %s=%d"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Need to specify a port with %s: '%s'"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Network upgrade parameters malformed, expecting %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Network upgrade parameters may only be overridden on regtest."),
QT_TRANSLATE_NOOP("nebulaproject-core", "No error"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Not enough file descriptors available."),
QT_TRANSLATE_NOOP("nebulaproject-core", "OS cryptographic RNG sanity check failure. Aborting."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Peers are being disconnected due time differences."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Please copy the included params files to the %s directory."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Please run the included %s script and then restart."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Specified -walletdir \"%s\" does not exist"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Specified -walletdir \"%s\" is a relative path"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Specified -walletdir \"%s\" is not a directory"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Specified blocks directory \"%s\" does not exist."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "This is not a deterministic masternode. 'local' option disabled."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "This product includes UPnP software written by Thomas Bernard."),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Transaction has too long of a mempool chain"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Transaction must have at least one recipient"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Unable to bind to %s on this computer. %s is probably already running."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Unable to create the PID file '%s': %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Unable to generate initial key!"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Unknown network specified in %s: '%s'"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Verifying wallet(s)..."),
QT_TRANSLATE_NOOP("nebulaproject-core", "Wallet %s resides outside data directory %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Wallet needed to be rewritten: restart %s to complete"),
...
QT_TRANSLATE_NOOP("nebulaproject-core", "Warning: Unsupported argument %s ignored, use %s"),
QT_TRANSLATE_NOOP("nebulaproject-core", "Warning: Unsupported argument %s ignored, use %s."),
QT_TRANSLATE_NOOP("nebulaproject-core", "You need to rebuild the database using %s to change %s"),
