 ...
 *  A CTxDestination is the internal data type encoded in a NEBULAPROJECT address
 */
...
/**
 * Generate a NEBULAPROJECT scriptPubKey for the given CTxDestination. Returns a P2PKH
