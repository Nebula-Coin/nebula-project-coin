...
std::vector<CSporkDef> sporkDefs = {
    MAKE_SPORK_DEF(SPORK_5_MAX_VALUE,                       1000),          // 1000 NBLA
...
// NEBULAPROJECT: on startup load spork values from previous session if they exist in the sporkDB
...
int CSporkManager::ProcessSporkMsg(CSporkMessage& spork)
{
    ...
    // NEBULAPROJECT: add to spork database.
