...
#ifndef NEBULAPROJECT_SUPPORT_ALLOCATORS_POOLED_SECURE_H
#define NEBULAPROJECT_SUPPORT_ALLOCATORS_POOLED_SECURE_H
...
#endif // NEBULAPROJECT_SUPPORT_ALLOCATORS_POOLED_SECURE_H
