...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("nebulaproject"), "Nebulaproject");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://nebulaproject.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/nebulaproject"));
    BOOST_CHECK(validateURL("https://foo.bar/nebulaproject/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.nebulaproject.com"));
