...
#ifndef NEBULAPROJECT_WALLET_H
#define NEBULAPROJECT_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_NEBULAPROJECT = 61000, // inherited version..
...
public:
     ...
     * NEBULAPROJECT: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 NBLA output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CNblaStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
