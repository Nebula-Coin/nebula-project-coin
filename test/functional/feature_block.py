...
# Copyright (c) 2020-2022 The NEBULAPROJECT Core developers
...
class FullBlockTest(NebulaprojectTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure nebulaprojectd isn't accepting b26
        ...
        # Extend the b28 chain to make sure nebulaprojectd isn't accepting b28
        ...
        # NEBULAPROJECT: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the nebulaproject code has custom code which does so);
