...
By default, nebulaprojectd will dump mempool on shutdown and
...
class MempoolPersistTest(NebulaprojectTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent nebulaprojectd from writing mempool.dat to disk. Verify that `savemempool` fails")
