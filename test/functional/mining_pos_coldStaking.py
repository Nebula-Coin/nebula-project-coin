...
from test_framework.nebulaproject_node import NebulaprojectTestNode
...
class NEBULAPROJECT_ColdStakingTest(NebulaprojectTestFramework):
    ...
    def init_test(self):
        ...
        for i in range(self.num_nodes):
            self.test_nodes.append(NebulaprojectTestNode())
    ...
    def run_test(self):
        ...
        # Create the block
        new_block = self.stake_next_block(1, stakeInputs, self.mocktime, staker_privkey)
        # Add output (dummy key address) to coinstake (taking 100 NBLA from the pot)
...
if __name__ == '__main__':
    NEBULAPROJECT_ColdStakingTest().main()
