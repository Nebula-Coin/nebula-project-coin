...
Also test that nodes that send unsupported service bits to nebulaprojectd are disconnected
...
class CNodeNoVersionBan(CLazyNode):
    ...
    # NOTE: implementation-specific check here. Remove if nebulaprojectd ban behavior changes
    def on_open(self):
        super().on_open()
...
class P2PLeakTest(NebulaprojectTestFramework):
