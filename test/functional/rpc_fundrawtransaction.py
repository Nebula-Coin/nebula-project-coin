...
class RawTransactionsTest(NebulaprojectTestFramework):
    ...
    def test_invalid_change_address(self):
        ...
        outputs = {self.nodes[0].getnewaddress(): 1.0}
        rawtx = self.nodes[2].createrawtransaction([], outputs)
        assert_raises_rpc_error(-8, "changeAddress must be a valid NEBULAPROJECT address",
