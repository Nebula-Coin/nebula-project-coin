...
class NetTest(NebulaprojectTestFramework):
    ...
    def _test_getnodeaddresses(self):
        ...
        self.nodes[0].addpeeraddress(ipv6_addr, 1818)

        # Add 50,000 IPv4 addresses to the address manager. Due to the way bucket
        ...
        for i in range(10000):
            ...
            self.nodes[0].addpeeraddress(a, 1818)
