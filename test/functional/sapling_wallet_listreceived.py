...
class ListReceivedTest (NebulaprojectTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 NBLA.
        ...
        # Send 1 NBLA to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 NBLA sending them all (fee is 0.1 NBLA)
        ...
        # Confirm transaction (2 NBLA from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 NBLA, send 0.6 NBLA + 0.05 NBLA fee
