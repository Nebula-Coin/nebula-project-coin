...
COIN = 100000000  # 1 NBLA in satoshis
...
# Objects that map to nebulaprojectd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in nebulaprojectd indicates these should be deserialized as blocks
