...
class NebulaprojectTestFramework():
    ...
    """
    Create a ProReg tx, which references an 100 NBLA UTXO as collateral.
...
class NebulaprojectDMNTestFramework(NebulaprojectTestFramework):
...
class NebulaprojectTier2TestFramework(NebulaprojectTestFramework):
    ...
    def set_test_params(self):
        ...
        self.extra_args = [["-nuparams=v5_shield:249", "-nuparams=NEBULAPROJECT_v5.5:250", "-nuparams=v6_evo:250", "-whitelist=127.0.0.1"]] * self.num_nodes
