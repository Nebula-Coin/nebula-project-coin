...
class DIP3Test(NebulaprojectTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 NBLA) to the operator, and (2 * 2.7 NBLA) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid NEBULAPROJECT address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid NEBULAPROJECT address InvalidPayee", controller.protx_update_registrar,
