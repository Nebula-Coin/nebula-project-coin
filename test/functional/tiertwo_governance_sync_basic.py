...
from test_framework.test_framework import NebulaprojectTier2TestFramework
...
class MasternodeGovernanceBasicTest(NebulaprojectTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.nebulaproject.org/t/test-proposal"
