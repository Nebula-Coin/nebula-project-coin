#!/usr/bin/env python3
# Copyright (c) 2023 The NEBULAPROJECT Core developers
# Distributed under the MIT software license, see the accompanying
# file COPYING or http://www.opensource.org/licenses/mit-license.php.
"""Test a generic LLQM signing session"""

from test_framework.test_framework import NebulaprojectDMNTestFramework
from test_framework.util import (
    assert_equal,
)
import time

class SigningSessionTest(NebulaprojectDMNTestFramework):

    def set_test_params(self):
        self.set_base_test_params()
        self.extra_args = [["-nuparams=v5_shield:1", "-nuparams=NEBULAPROJECT_v5.5:130", "-nuparams=v6_evo:130", "-debug=llmq", "-debug=dkg", "-debug=net"]] * self.num_nodes
